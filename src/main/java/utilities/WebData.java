...
public class WebData extends Base {
	...
	public void add_a_TODO() {
		...
		log.info("todo added successfully ");
	}
	...
	public void verify_To_do_AreAdded() {
		...
		log.info("addition of element successfully verified");
	...
	public void make_some_task_completed(String[] tasks) {
		...
		log.info("completed the required task");
	}
	...
	public void validateAfterDeletion() {
		...
		log.info("verified the deletion of todo");
	}
	...
	public void fetchCompletedAndValidate() {
		...
		log.info("fetched and validated  the complete actions");
	}
	...
	public void fetchActiveTodoAndValidate() {
		...
		log.info("fetched and validated  the Active actions");
	}
